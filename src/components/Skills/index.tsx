...
// Pass in the ScrollDown eventlistener through props and check if in focus?
      ...
      <Visibility parentRef={ref}>
        ...
        <div className="skills-category">
          ...
          <div className="right-side">
            ...
            <p>
              ...
              frequently use <b>Typescript</b> for features such as Static
              Typing and for more Object-Oriented Code. However, I am also
              familiar with
        ...
        <div className="skills-category">
          <div className="left-side">
            ...
            <p>
              Similarily to the Front-End, My main server-side framework of
              choice is <b>Express</b>. I am comfortable with creating REST APIs
              as well as using <b>GraphQL</b> for requests. As for the database,
              I am familiar with both relational and non-relational databases
              such as <b>MongoDB</b> and <b>MySQL</b>. I have also used
              cloud-systems such as <b>Firebase</b> and <b>Amazon AWS</b> as
              well.
            </p>
          </div>
        ...
        <div className="skills-category">
          ...
          <div className="right-side">
            ...
            <p>
              I primarily focus on building the layout with Adobe XD before
              coding anything as it allows for further consideration of the
              User's experience. Alongside this, I use <b>Photoshop</b> and{" "}
              <b>Illustrator</b> to make SVGs and animations. My go-to for
              Website styling is usually <b>SASS</b>
            </p>
          </div>
        </div>
      </Visibility>
